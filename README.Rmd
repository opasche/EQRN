...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/EQRN)](https://CRAN.R-project.org/package=EQRN)
...
EQRN is a framework for forecasting and extrapolating measures of conditional risk (e.g. of extreme or unprecedented events), 
...
the necessary backend software from the [`torch`](https://torch.mlverse.org/) dependency is automatically installed. 
