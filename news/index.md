...
- The EQRN R package has been accepted for publication on the
  ...
  on <https://cran.r-project.org/package=EQRN>, with DOI
  [doi:10.32614/CRAN.package.EQRN](https://doi.org/10.32614/CRAN.package.EQRN).
  One can now install EQRN by simply calling `install.packages("EQRN")`
  in R.
...
- Final version from the research paper “Neural Networks for Extreme
  ...
  by Olivier C. Pasche and Sebastian Engelke
